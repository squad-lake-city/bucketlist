...
/***/ function(module, exports, __webpack_require__) {
	...
	var bucklist = __webpack_require__(12);
	var maps = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  var dataCredentialsMatch = data.credentials.password === data.credentials.password_confirmation;
	  var passwordBlank = $(".signup-password").val() !== "";
	  var passwordConfirmBlank = $(".signup-password-confirm").val() !== "";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signUpSuccess = function signUpSuccess() {
	  var transferEmail = $("#sign-up .signup-email").val();
	  $("#sign-in").addClass("open");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetBucketlist = function onGetBucketlist(event) {
	  event.preventDefault();
	  api.getBucketlist().then(ui.getBucketlistSuccess).catch(ui.getBucketlistFailure);
	};

	var onHideBucketlist = function onHideBucketlist(event) {
	  event.preventDefault();
	  ui.hideBucketlist();
	};
	...
	var onShowBucketlist = function onShowBucketlist(event) {
	  event.preventDefault();
	  var id = event.target.dataset.id;
	  store.mapPlaceId = $(this).attr("data-placeid");
	  store.activityDesc = $(this).attr("data-activity");
	  api.showBucketlist(id).done(ui.showBucketlistSuccess).fail(ui.showBucketlistFailure);
	};

	var onCreateBucketlist = function onCreateBucketlist(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createBucketlist(data).then(ui.createBucketlistSuccess).catch(ui.createBucketlistFailure);
	};

	var onDeleteBucketlist = function onDeleteBucketlist(event) {
	  event.preventDefault();
	  var id = event.target.dataset.id;
	  api.deleteBucketlist(id).then(function () {
	    $('.content').empty();
	    api.getBucketlist().then(ui.getBucketlistSuccess).catch(ui.getBucketlistFailure);
	  }).then(ui.deleteBucketlistSuccess).catch(ui.deleteBucketlistFailure);
	};

	var onUpdateBucketlist = function onUpdateBucketlist(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var id = event.target.dataset.id;
	  api.updateBucketlist(data, id).then(function () {
	    $('.content').empty();
	    api.getBucketlist().then(ui.getBucketlistSuccess).catch(ui.getBucketlistFailure);
	  }).then(ui.updateBucketlistSuccess).catch(ui.updateBucketlistFailure);
	};

	var onEditItem = function onEditItem() {
	  ...
	  var currentbuttonDataId = $(this).parent().children(".edit-bucketlist-item").attr("data-id");
	  var currentCancelButton = $(this).parent().parent().children(".cancel-edit-td").children(".cancel-bucketlist-edit");
	  ...
	  var currentActivityDiv = $(this).parent().parent().children(".bl-activity");
	  var currentCompletedDiv = $(this).parent().parent().children(".bl-completed");
	  // let saveCompletedDivVal = $(this).parent().parent().children(".bl-completed").text();

	  var saveCurrentCompleted = $(this).parent().parent().children(".bl-completed").text().trim();
	  ...
	  var shownCheckHtml = $('<input class="checkbox-field" name="bucketlist[completed]" placeholder="Completed?" type="checkbox">');
	  var activityHtml = $('<input class="create-form-clear form-clear update-activity-table" type="text" name="bucketlist[activity]" placeholder="activity">');
	  ...
	  var dummyButton = $('<button class="dummy-update-btn">Submit</button>');

	  $(this).hide();
	  $(this).parent().append(dummyButton);
	};

	var editBucketListItem = function editBucketListItem(id, location, activity, placeId, completed) {
	  return $.ajax({
	...
	var onUpdatedSubmit = function onUpdatedSubmit(event) {
	  event.preventDefault();

	  var submitButton = $(this).parent().children(".edit-bucketlist-item");

	  var activityVal = $(this).parent().parent().children(".bl-activity").children(".update-activity-table").val();
	  ...
	  var location = $(submitButton).attr("data-location");
	  var placeid = $(submitButton).attr("data-placeid");
	  // $(submitButton).attr("data-activity", activityVal);
	  // $(submitButton).attr("data-completed", completedVal);

	  editBucketListItem(id, location, activityVal, placeid, completed).then(function () {
	    $('.content').empty();
	    api.getBucketlist().then(ui.getBucketlistSuccess).catch(ui.getBucketlistFailure);
	  }).done(ui.updateBucketlistItemSuccess).fail(ui.updateBucketlistItemFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showBucketlist = function showBucketlist(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/bucketlists/' + id,
	    method: 'GET',
	    headers: {
	...
	var createBucketlist = function createBucketlist(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/bucketlists',
	    method: 'POST',
	    headers: {
	...
	var deleteBucketlist = function deleteBucketlist(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/bucketlists/' + id,
	    method: 'DELETE',
	    headers: {
	...
	var updateBucketlist = function updateBucketlist(data, id) {
	  return $.ajax({
	    url: config.apiOrigin + '/bucketlists/' + id,
	    method: 'PATCH',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var createMaps = __webpack_require__(15);

	// handlebars
	var displayBucketlistTemplate = __webpack_require__(16);
	var showBucketlistTemplate = __webpack_require__(36);

	var getBucketlistSuccess = function getBucketlistSuccess(data) {
	  var displayBucketlistsHtml = displayBucketlistTemplate({
	...
	var hideBucketlist = function hideBucketlist() {
	  $('.content').empty();
	  $('.number').hide();
	  $('#map').hide();
	  $('#index-bl-item').show();
	...
	var showBucketlistSuccess = function showBucketlistSuccess(data) {
	  var showBucketlistHtml = showBucketlistTemplate({
	...
	var showBucketlistCreateForm = function showBucketlistCreateForm() {
	  var createFormHtml = '<input name="bucketlist[completed]" type="hidden" value="false"><input class="checkbox-field" name="bucketlist[completed]" placeholder="Completed?" type="checkbox" value="true">';
	...
	var createBucketlistSuccess = function createBucketlistSuccess() {
	...
	var createBucketlistFailure = function createBucketlistFailure() {
	...
	var deleteBucketlistSuccess = function deleteBucketlistSuccess() {
	  $('.log').text('Delete success!').show(0).delay(5000).slideUp(500);
	  $('.log').show();
	  $('#map').hide();
	};

	var deleteBucketlistFailure = function deleteBucketlistFailure() {
	  $('.log-fail').text('Item not deleted').show(0).delay(5000).slideUp(500);
	  $('.log-fail').show();
	};

	var updateBucketlistSuccess = function updateBucketlistSuccess() {
	...
	var updateBucketlistFailure = function updateBucketlistFailure() {
	  $('.log-fail').text('Update failed, please make sure all the fields are filled out').show(0).delay(5000).slideUp(500);
	  $('.log-fail').show();
	};

	var updateBucketlistItemSuccess = function updateBucketlistItemSuccess() {
	  $('.log').text('Update success!').show(0).delay(5000).slideUp(500);
	  $("#create-bl-item").hide();
	  $("#insert-checkbox-create").children().remove();
	  $('.log').show();
	...
	var updateBucketlistItemFailure = function updateBucketlistItemFailure() {
	  $('.log-fail').text('Update failed, please make sure all the fields are filled out').show(0).delay(5000).slideUp(500);
	  $('.log-fail').show();
	};
	...
	module.exports = {
	  ...
	  hideBucketlist: hideBucketlist,
	  showBucketlistSuccess: showBucketlistSuccess,
	  updateBucketlistSuccess: updateBucketlistSuccess,
	  updateBucketlistFailure: updateBucketlistFailure,
	  deleteBucketlistSuccess: deleteBucketlistSuccess,
	  deleteBucketlistFailure: deleteBucketlistFailure,
	  updateBucketlistItemSuccess: updateBucketlistItemSuccess,
	  updateBucketlistItemFailure: updateBucketlistItemFailure,
	  showBucketlistCreateForm: showBucketlistCreateForm
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createMap = function createMap(tempPlaceId, activityText) {
	  var placeId = tempPlaceId;
	    ...
	    geocoder.geocode({ 'placeId': store.mapPlaceId }, function (results, status) {
	      if (status === 'OK') {
	        if (results[0]) {
	          ...
	          var activity = activityText;

	          var activityArray = activity.split(" ");
	          ...
	          var label = '<div class="map-label"><div id="activity-label">' + activity + '</div><div id="address-label">' + address + '</div></div>';
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <tr>\n      <tbody>\n        <th scope=\"row\" data-id=\""
	    ...
	    + "\"></th>\n        <td class=\"bl-location\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
	    + "</td>\n        <td class=\"bl-activity\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.activity : stack1), depth0))
	    + "</td>\n        <td class=\"bl-completed\">\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},((stack1 = blockParams[0][0]) != null ? stack1.completed : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "        </td>\n        <td><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\" data-location=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
	    ...
	    + "\" data-placeId=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.placeId : stack1), depth0))
	    + "\" type=\"button\" name=\"button\" class=\"show-bucketlist btn btn-default\">View</button></td>\n        <td><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\" data-location=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
	    + "\" data-activity=\""
	    ...
	    + "\" data-placeId=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.placeId : stack1), depth0))
	    + "\" type=\"button\" name=\"button\" class=\"remove-bucketlist-item glyphicon glyphicon-remove-sign\"></button></td>\n        <td><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\" data-location=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
	    + "\" data-activity=\""
	    ...
	    + "\" data-placeId=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.placeId : stack1), depth0))
	    + "\" type=\"button\" name=\"button\" class=\"edit-bucketlist-item glyphicon glyphicon-edit\"></button></td>\n        <td class=\"cancel-edit-td\"><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\" data-location=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
	    + "\" data-activity=\""
	    ...
	    + "\" data-placeId=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.placeId : stack1), depth0))
	    + "\" type=\"button\" name=\"button\" class=\"cancel-bucketlist-edit glyphicon glyphicon-triangle-left\"></button></td>\n    </tr>\n    </tbody>\n";
	  ...
	  return "<table class=\"table table-hover complete-bucketlist-table\">\n  <thead>\n    <tr>\n      <th></th>\n      <th>Location</th>\n      <th>Activity</th>\n      <th>Completed</th>\n      <th> VIEW </th>\n      <th> DELETE </th>\n      <th> EDIT </th>\n      <th class=\"cancel-edit-th\">Cancel</th>\n    </tr>\n  </thead>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.bucketlists : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</table>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.bucketlist : depth0)) != null ? stack1._id : stack1), depth0))
	    + "\">\n  <table class=\"table table-hover view-table\">\n    <thead>\n      <tr>\n        <th></th>\n        <th>Location</th>\n        <th>Activity</th>\n        <th>Completed</th>\n        <th> DELETE </th>\n        <th> EDIT </th>\n        <th class=\"cancel-edit-th\">Cancel</th>\n      </tr>\n    </thead>\n    <tr>\n      <tbody>\n        <th scope=\"row\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.bucketlist : depth0)) != null ? stack1._id : stack1), depth0))
	    + "\"></th>\n        <td class=\"bl-location\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.bucketlist : depth0)) != null ? stack1.location : stack1), depth0))
	    + "</td>\n        <td class=\"bl-activity\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.bucketlist : depth0)) != null ? stack1.activity : stack1), depth0))
	    + "</td>\n        <td class=\"bl-completed\">\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.bucketlist : depth0)) != null ? stack1.completed : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
	    + "        </td>\n        <td><button data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.bucketlist : depth0)) != null ? stack1._id : stack1), depth0))
	    + "\" data-location=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.bucketlist : depth0)) != null ? stack1.location : stack1), depth0))
	    ...
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.bucketlist : depth0)) != null ? stack1.activity : stack1), depth0))
	    + "\" data-completed=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.bucketlist : depth0)) != null ? stack1.completed : stack1), depth0))
	    + "\" data-placeId=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.bucketlist : depth0)) != null ? stack1.placeId : stack1), depth0))
	    + "\" type=\"button\" name=\"button\" class=\"remove-bucketlist-item glyphicon glyphicon-remove-sign\"></button></td>\n        <td><button data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.bucketlist : depth0)) != null ? stack1._id : stack1), depth0))
	    + "\" data-location=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.bucketlist : depth0)) != null ? stack1.location : stack1), depth0))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetMapResults = function onGetMapResults(event) {
	  event.preventDefault();
	  api.getMapResults()
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getMapResults = function getMapResults() {
