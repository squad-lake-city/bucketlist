...
//       format: 'json',
//       headers: {
//         "User-Agent": 'Google-Locations (https://www.npmjs.org/package/google-locations)'
//       },
...
//
//   _self.textsearch({
//     query: 'phone number ' + options.phone
//   }, function(err, result) {
//     if (err) {
//       return cb({
//       message: "Error from textsearch",
//       error: err
//     });
//   }
...
//           details.push(result);
//         }
//         if (details.length + errors.length === j) {
//           return cb(null, {
//           details: details,
//           errors: errors
//         });
...
//   // Copy options object
//   geocodeOptions = _.extend({}, geocodeOptions);
//   let options = {
...
//     query.radius = searchOptions.radius;
//   }
//   return query;
// }
//
